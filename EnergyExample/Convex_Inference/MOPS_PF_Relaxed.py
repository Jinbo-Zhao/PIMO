...
if __name__ == "__main__":
    ...
    PF_Confidence,PF_time_stats = parallel_PF_Confidence_relaxed( s, k, d, experimental_set, resolution_1, resolution_2, start_point1, step_size1, start_point2, step_size2,LB_list, UB_list)
    np.save('PF_Confidence_relaxed.npy', PF_Confidence)
    np.save('PF_time_stats_relaxed.npy', PF_time_stats)
