...
if __name__ == "__main__":
    ...
    x_lower_bound=8.5
    x_upper_bound=10.0
    y_lower_bound=61.111111111111114
    y_upper_bound=64.44444444444444
    
    ES_Confidence,ES_time_stats = parallel_ES_Confidence_Interested( s, k, d, experimental_set, resolution_1, resolution_2, start_point1, step_size1, start_point2, step_size2,x_lower_bound,x_upper_bound,y_lower_bound,y_upper_bound)
    np.save('ES_Confidence_Interested.npy', ES_Confidence)
    np.save('ES_time_stats_Interested.npy', ES_time_stats)
