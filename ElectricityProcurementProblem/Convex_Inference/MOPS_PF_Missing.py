...
if __name__ == "__main__":
    ...
    PF_Confidence,PF_time_stats = parallel_PF_Confidence_missing(s, k, d, experimental_set, resolution_1, resolution_2, start_point1, step_size1, start_point2, step_size2)
    np.save('PF_Confidence_M.npy', PF_Confidence)
    np.save('PF_time_stats_M.npy', PF_time_stats)
